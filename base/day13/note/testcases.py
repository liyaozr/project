...
"""
import unittest
from day13.note.login import login_check


class LoginTest(unittest.TestCase):

    def test_1login_pass(self):
        # 正常登录
        # 第一步：准备用例数据
        # 入参
    ...
    def test_6pwd_error02(self):
        # 不通过的用例
        # 第一步：准备用例数据
        # 入参
        data = ("python26", "lemonban111")
        # 预期结果
        expected = {"code": 1, "msg": "账号或密码不正确67890"}
